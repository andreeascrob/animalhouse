export class BoardTopic extends HTMLElement {
	template(elem) {
		elem.innerHTML = `
<style>
...
<div class="flex flex-row border border-neutral-300 dark:border-neutral-800 rounded-xl shadow-md max-w-screen-lg mx-auto">
	...
	<div class="w-4/5 p-4">
		${this.getAttribute('imageUrl') ? '<img src="' + this.getAttribute('imageUrl') + '" class="max-h-60" alt="">' : ''}
...
`;
	...
	static get observedAttributes() {
		return ['profileimage', 'name', 'surname', 'imageUrl', 'text'];
	}
